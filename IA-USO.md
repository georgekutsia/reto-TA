...
- **Apify + GPT extractor**  puntual del DOM/CSS del sitio original. El snippet resultó incompleto (sin laps ni milisegundos), así que el código se reescribió manualmente, pero sirvió para captar la jerarquía base.
- **NotebookLM (Google)**  
...
!(public\img-mg\Prompt8.png)
!(public\img-mg\Prompt9.png)
!(public\img-mg\Prompt10.png)
!(public\img-mg\Prompt11.png)

9. **Tras hacer todos los ajustes pequeños entre medias, pasé a la funcionalidad de Stopwatch.**

!(public\img-mg\Prompt12.png)
!(public\img-mg\Prompt13.png)

10. **Entre otros prompts pequeños y probando que todo funciona, pasé a la parte de Countdown**

!(public\img-mg\Prompt14.png)
!(public\img-mg\Prompt15.png)
!(public\img-mg\Prompt16.png)
!(public\img-mg\Prompt17.png)
!(public\img-mg\Prompt18.png)
...
!(public\img-mg\Cod1.png)
!(public\img-mg\Cod2.png)
!(public\img-mg\Cod3.png)
...
- **Ideación visual**: describí las capturas y la IA armó la base (barras azules, keypad, paneles). Después ajusté manualmente tamaños, colores y tipografías para que coincidieran con la
